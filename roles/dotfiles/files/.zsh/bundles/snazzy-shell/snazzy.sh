#!/bin/sh
# Snazzy scheme by Sindre Sorhus (http://sindresorhus.com)
# Ported to shell script by James Ramsay (http://jramsay.com.au)
# Based on Base16 Shell template by Chris Kempson (http://chriskempson.com)
...
color08="72/74/79" # Base 03 - Bright Black
...
color16="de/93/5f" # Base 09 - Orange?? Bonus color??
color17="a3/68/5a" # Base 0F - Deep red?? Bonus color??
color18="40/42/4c" # Base 01
color19="59/5b/63" # Base 02
color20="8b/8d/90" # Base 04
color21="e0/e0/e0" # Base 06
color_foreground="a4/a5/a7" # Base 05
